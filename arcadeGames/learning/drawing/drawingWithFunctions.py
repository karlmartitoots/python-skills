...
def draw_the_sun(x,y):
    """
    This function draws the sun at the specified location.
    """
    arcade.draw_circle_filled(x,y,SCREEN_HEIGHT//16,
                                arcade.color.YELLOW)
...
def main():
    ...
    draw_bird(70, 500)
    draw_bird(470, 350)
    draw_the_sun(SCREEN_WIDTH*7/8,SCREEN_HEIGHT*7/8)
